...
if ( ! class_exists( 'Hester_Customizer_Widget' ) ) :

	/**
	 * Hester Customizer widget class
	 */
	class Hester_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->option_name = 'hester_customizer_widget_' . $this->id_base;
		...
		public function template() {
			?>
			<div class="widget" id="hester_widget-<?php echo esc_attr( $this->id_base ); ?>-<?php echo esc_attr( $this->number ); ?>" data-widget-base="<?php echo esc_attr( $this->id_base ); ?>" data-widget-type="<?php echo esc_attr( $this->type ); ?>">

				<div class="widget-top">		

					<div class="widget-title-action">
						<button type="button" class="widget-action" aria-expanded="false">
							<span class="screen-reader-text"><?php esc_html_e( 'Edit widget:', 'hester' ); ?> <?php echo esc_html( $this->name ); ?></span>
					...
					<div class="form">
						<div class="widget-content">
							...
							<?php if ( isset( $this->locations ) && is_array( $this->locations ) && ! empty( $this->locations ) ) { ?>
								...
								<p>
									<label for="hester-widget-location"><?php esc_html_e( 'Widget Location', 'hester' ); ?></label>
							...
							<?php if ( isset( $this->visibility ) && is_array( $this->visibility ) && ! empty( $this->visibility ) ) { ?>
								...
								<p>
									<label for="hester-widget-visibility"><?php esc_html_e( 'Visibility', 'hester' ); ?></label>
						...
						<div class="widget-control-actions">
							<div class="alignleft">
								<button type="button" class="button-link button-link-delete widget-control-remove"><?php esc_html_e( 'Delete', 'hester' ); ?></button>
								<span class="widget-control-close-wrapper">
									|
									<button type="button" class="button-link widget-control-close"><?php esc_html_e( 'Done', 'hester' ); ?></button>
								</span>
							</div>
