...
if ( ! class_exists( 'Hester_Customizer_Widget_Search' ) ) :

	/**
	 * Hester Customizer widget class
	 */
	class Hester_Customizer_Widget_Search extends Hester_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->name        = __( 'Search', 'hester' );
			$this->description = __( 'A search form for your site.', 'hester' );
		...
		public function form() {
			...
			if ( ! empty( $this->styles ) ) { ?>
				<p class="hester-widget-search-style">
