...
if ( ! class_exists( 'Hester_Customizer_Widget_Button' ) ) :

	/**
	 * Hester Customizer widget class
	 */
	class Hester_Customizer_Widget_Button extends Hester_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$args['values']['text']       = wp_kses( $args['values']['text'], hester_get_allowed_html_tags() );
			...
			$this->name        = __( 'Button', 'hester' );
			$this->description = __( 'A button with custom link.', 'hester' );
		...
		public function form() {
			...
			<!-- Text -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-text"><?php esc_html_e( 'Text', 'hester' ); ?>:</label>
				<input 
					type="text" 
					...
					placeholder="<?php esc_attr_e( 'Button Text', 'hester' ); ?>"/>
			</p>

			<!-- URL -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-url"><?php esc_html_e( 'URL', 'hester' ); ?>:</label>
				<input 
					type="text" 
					...
					placeholder="<?php esc_attr_e( 'Button URL', 'hester' ); ?>" />
			</p>

			<!-- Target -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-target"><?php esc_html_e( 'Open link in', 'hester' ); ?>:</label>
				<span class="buttonset">
					<input 
						...
						<label 
							...
							<?php esc_html_e( 'Same Tab', 'hester' ); ?>
						</label>
					</input>
					<input 
						class="switch-input screen-reader-text" 
			...
			<?php if ( ! empty( $this->styles ) ) { ?>
				<!-- Styles -->
				<p class="hester-widget-button-style">
			...
			<!-- Class -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-class"><?php esc_html_e( 'Additional class', 'hester' ); ?>:</label>
				<input 
					type="text" 
