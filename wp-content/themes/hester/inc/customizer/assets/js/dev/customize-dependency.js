;( function( $ ) {
	...
	var hesterDependencies = {
		...
		init: function() {
			...
			wp.customize.control.each( function( control ) {
				self.showHesterControl( control );
			});
					...
					wp.customize( master, function( setting ) {
						var setupControl = function( control ) {
							...
							isDisplayed = function() {
								return self.showHesterControl( wp.customize.control( slave ) );
							};
		 ...
		 * @returns {bool}
		 */
		showHesterControl: function( control ) {
			var self     = this,
				show     = true,
				i;
		 ...
		 *
		 * @since 1.0.0
		 * @param {Object} requirement - The requirement, inherited from showHesterControl.
	...
	}; // END var hesterDependencies

	$( document ).ready( function() {
		hesterDependencies.init();
	});
