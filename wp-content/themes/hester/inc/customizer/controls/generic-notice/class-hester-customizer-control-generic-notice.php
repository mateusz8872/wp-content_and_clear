 ...
 * @access public
 */
class Hester_Customizer_Control_Generic_Notice extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'hester-generic-notice';
	...
	public function enqueue() {
		 Hester_Customizer_Plugin_Install_Helper::instance()->enqueue_scripts();
	}
	...
	protected function render_template() {
		...
		<li id="accordion-section-{{ data.id }}"
				class="hester-notice accordion-section control-section control-section-{{ data.type }} cannot-expand" style="position:relative;">
	...
	public function create_plugin_install_button( $slug, $settings = array() ) {
		return Hester_Customizer_Plugin_Install_Helper::instance()->get_button_html( $slug, $settings );
	}
}
