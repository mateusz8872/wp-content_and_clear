...
( function( api, $ ) {
    api.controlConstructor['hester-repeater'] = api.Control.extend({
        ready: function() {
            var control = this;
            setTimeout( function() {
                control._init();
        ...
        _init: function() {
            ...
            control.autocorrect_range_input_number = function( input_number, timeout ) {
                ...
                var range_input = input_number,
                    ...
                    reset = parseFloat( range.find( '.hester-reset-range' ).attr( 'data-reset_value' ) ),
            ...
            if ( ! window._upload_hester ) {
                ...
                window._upload_hester = wp.media({
            ...
            window._upload_hester.on( 'close', function() {

                // get selections and save to hidden input plus other AJAX stuff etc.
                var selection = window._upload_hester.state().get( 'selection' );

                // console.log(selection);
            });
            window.media_current = {};
            window.media_btn = {};
            window._upload_hester.on( 'select', function() {

                // Grab our attachment selection and construct a JSON representation of the model.
                var media_attachment = window._upload_hester.state().get( 'selection' ).first().toJSON();
            ...
            control.handleGradient = function( $context ) {
                var control = this,
                    ...
                    range_input,
                    value,
                    hester_range_input_number_timeout,
                ...
                $( '.item-gradient', $context ).each( function() {
                    ...
                    _item.find( '.hester-range-wrapper' ).each( function() {
                        var $this = $( this );
                        ...
                        $this.find( 'input.hester-range-input' ).on( 'change keyup', function() {
                            control.autocorrect_range_input_number( $( this ), 1000, hester_range_input_number_timeout );
                        }).on( 'focusout', function() {
                            control.autocorrect_range_input_number( $( this ), 0, hester_range_input_number_timeout );
                        });
                    ...
                    _item.on( 'change', '.hester-select-wrapper', function() {
                        control.update_value();
                    });
            ...
            control.handleBackground = function( $context ) {
                ...
                $( '.item-design-options', $context ).each( function() {
                    ...
                    // Linked button
                    _item.on( 'click', '.hester-spacing-linked', function() {
                    ...
                    // Unlinked button
                    _item.on( 'click', '.hester-spacing-unlinked', function() {
            ...
            control.actions = function( $context ) {
                if ( control.params.live_title_id ) {
                    ...
                    if ( 'hester_section_order_styling' === control.id ) {
...
jQuery( document ).ready( function( $ ) {
    ...
    var options_font_type = '',
        icon_group = '';
    $.each( Hester_Icon_Picker.fonts, function( key, font ) {
        font = $.extend({}, {
            url: '',
            name: '',
            prefix: '',
    ...
    icon_picker.find( '.c-icon-search input' ).attr( 'placeholder', Hester_Icon_Picker.search );
