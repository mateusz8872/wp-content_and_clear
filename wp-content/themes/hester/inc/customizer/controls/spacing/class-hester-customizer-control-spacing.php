<?php
/**
 * Hester Customizer custom spacing control class.
 *
 * @package     Hester
...
if ( ! class_exists( 'Hester_Customizer_Control_Spacing' ) ) :
	/**
	 * Hester Customizer custom select control class.
	 */
	class Hester_Customizer_Control_Spacing extends Hester_Customizer_Control {
		...
		public function to_json() {
			...
			$this->json['title']   = esc_html__( 'Link values', 'hester' );
		...
		protected function content_template() {
			?>
			<div class="hester-control-wrapper hester-spacing-wrapper<# if ( data.responsive ) { #> hester-control-responsive <# } #>">
