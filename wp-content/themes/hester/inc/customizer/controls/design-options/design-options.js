;(function($) {
 	...
 	wp.customize.controlConstructor['hester-design-options'] = wp.customize.Control.extend({
		...
		ready: function() {
			...
			// Range controls.
			control.container.find( '.hester-range-wrapper' ).each( function() {
				var $this = $(this);
			...
			control.container.find( 'input.hester-range-input' ).on( 'change keyup', function() {
			...
			control.container.on( 'change', '.hester-select-wrapper', function(){
				control.update_value();
			});
			...
			// Linked button
			control.container.on( 'click', '.hester-spacing-linked', function() {
			...
			// Unlinked button
			control.container.on( 'click', '.hester-spacing-unlinked', function() {
