...
if ( ! class_exists( 'Hester_Customizer_Control_Alignment' ) ) :
	/**
	 * Hester Customizer custom background control class.
	 */
	class Hester_Customizer_Control_Alignment extends Hester_Customizer_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->strings = wp_parse_args(
				...
				array(
					'top-left'     => __( 'Top Left', 'hester' ),
					'top'          => __( 'Top', 'hester' ),
					'top-right'    => __( 'Top Right', 'hester' ),
					'left'         => __( 'Left', 'hester' ),
					'center'       => __( 'Center', 'hester' ),
					'right'        => __( 'Right', 'hester' ),
					'bottom-left'  => __( 'Bottom Left', 'hester' ),
					'bottom'       => __( 'Bottom', 'hester' ),
					'bottom-right' => __( 'Bottom Right', 'hester' ),
				)
			);
		...
		protected function content_template() {
			?>
			<div class="hester-alignment-wrapper hester-control-wrapper">
				...
				<div class="hester-alignment-control">

					<# if ( ! data.choices['top-left'] && ! data.choices['top'] && ! data.choices['top-right'] ) { #>
						<div class="button-group hester-top">
							<label class="hester-left {{{ data.choices['top-left']}}}">
							...
							<label class="hester-center {{{ data.choices['top']}}}">
							...
							<label class="hester-right {{{ data.choices['top-right']}}}">
					...
					<# if ( ! data.choices['left'] && ! data.choices['center'] && ! data.choices['right'] ) { #>
						<div class="button-group hester-middle">
							<label class="hester-left {{{ data.choices['left']}}}">
							...
							<label class="hester-center {{{ data.choices['center']}}}">
							...
							<label class="hester-right {{{ data.choices['right']}}}">
					...
					<# if ( ! data.choices['bottom-left'] && ! data.choices['bottom'] && ! data.choices['bottom-right'] ) { #>							
						<div class="button-group hester-bottom">
							<label class="hester-left {{{ data.choices['bottom-left']}}}">
							...
							<label class="hester-center {{{ data.choices['bottom']}}}">
							...
							<label class="hester-right {{{ data.choices['bottom-right']}}}">
