...
if ( ! class_exists( 'Hester_Customizer_Control_Button' ) ) :
	 ...
	 * Hester Customizer custom background control class.
	 */
	class Hester_Customizer_Control_Button extends Hester_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="hester-button-wrapper hester-control-wrapper">
			...
			<# if ( data.description ) { #>
				<div class="description customize-control-description hester-field">{{{ data.description }}}</div>
			<# } #>
