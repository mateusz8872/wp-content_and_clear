...
if ( ! class_exists( 'Hester_Customizer_Control_Sortable' ) ) :
	/**
	 * Hester Customizer custom select control class.
	 */
	class Hester_Customizer_Control_Sortable extends Hester_Customizer_Control {
		...
		protected function content_template() {
			?>
				<div class="hester-control-wrapper hester-sortable-wrapper">
					...
					<ul class="hester-sortable-control">
						<# for ( key in data.value ) { #>
							<li class="hester-sortable-item<# if ( _.has( data.value, key) && ! data.value[ key ] || ! _.has( data.value, key ) && _.has( data.default, key ) && ! data.default[ key ] ) { #> invisible<# } #>" data-value="{{ key }}">
								<# if ( data.sortable ) { #>
