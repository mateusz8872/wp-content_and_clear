<?php
/**
 * Hester Customizer custom text control class.
 *
 * @package     Hester
...
if ( ! class_exists( 'Hester_Customizer_Control_Datetime' ) ) :
	/**
	 * Hester Customizer custom select control class.
	 */
	class Hester_Customizer_Control_Datetime extends Hester_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="hester-control-wrapper hester-text-wrapper">
				...
				<label>
					...
					<div class="hester-info-text">{{{ data.info }}}</div>
				</label>
