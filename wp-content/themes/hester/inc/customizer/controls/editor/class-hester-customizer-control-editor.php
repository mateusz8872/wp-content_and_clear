...
/**
 * Hester Customizer editor control class.
 */
class Hester_Customizer_Control_Editor extends Hester_Customizer_Control {
	/**
	...
	protected function content_template() {
		?>
		<div class="hester-control-wrapper wp-js-editor hester-textarea-wrapper">
			<label>
				<# if ( data.label ) { #>
