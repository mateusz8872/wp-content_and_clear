<?php
/**
 * Hester Customizer custom textarea control class.
 *
 * @package     Hester
...
if ( ! class_exists( 'Hester_Customizer_Control_Textarea' ) ) :
	/**
	 * Hester Customizer custom select control class.
	 */
	class Hester_Customizer_Control_Textarea extends Hester_Customizer_Control {
		...
		protected function content_template() {
			?>
			<div class="hester-control-wrapper hester-textarea-wrapper">
