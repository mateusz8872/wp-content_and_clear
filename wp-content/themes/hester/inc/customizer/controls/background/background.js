;( function( $ ) {
	...
	wp.customize.controlConstructor['hester-background'] = wp.customize.Control.extend({
		...
		ready: function() {
			...
			control.container.find( 'input[type=range]' ).on( 'mousedown', function() {
				...
				range 			= $( this );
				range_input 	= range.parent().children( '.hester-range-input' );
				...
				range.mousemove( function() {
					...
					clearTimeout( hester_range_input_number_timeout );

					hester_range_input_number_timeout = setTimeout( function() {
