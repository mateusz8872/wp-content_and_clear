! ( function( $ ) {
wp.customize.controlConstructor['hester-background'] = wp.customize.Control.extend({ready: function() {
'use strict';var range, range_input, hester_range_input_number_timeout,
control = this,
...
control.autocorrect_range_input_number( $( this ), 1e3, hester_range_input_number_timeout );
...
range = $( this ), range_input = range.parent().children( '.hester-range-input' ), value = range.attr( 'value' ), range_input.val( value ), range.mousemove( ( function() {
value = range.attr( 'value' ), range_input.val( value ), clearTimeout( hester_range_input_number_timeout ), hester_range_input_number_timeout = setTimeout( ( function() {
