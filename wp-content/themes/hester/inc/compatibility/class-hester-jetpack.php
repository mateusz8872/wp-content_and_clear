...
if ( ! class_exists( 'Hester_Jetpack' ) ) :
	/**
	 * Jetpack compatibility class.
	 */
	class Hester_Jetpack {
		...
		public function tweak_credits_link() {
			return '<a href="https://wordpress.org/" rel="noopener noreferrer" target="_blank">' . esc_html__( 'Proudly powered by WordPress', 'hester' ) . '</a> | <a href="https://peregrine-themes.com/hester/?utm_medium=jetpack&utm_source=tweaklink&utm_campaign=upgradeToPro" rel="noopener noreferrer" target="_blank">Hester Theme</a>';
		}
		...
		public function filter_infinite_scroll_js_settings( $settings ) {
			...
			$settings['text'] = esc_html__( 'Load More', 'hester' );
