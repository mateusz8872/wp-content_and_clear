				...
				<div class="hester-container">
					...
					<div class="hester-flex-row gy-md-5 gy-5 is-services-init-s1 active__focus-row">
						...
						foreach ( $slides as $key => $slide ) {
							...
							$link  = $slide->add_link ? sprintf( '<div class="readmore"><a href="%1$s" tabindex="0"><span>%2$s</span>%3$s</a></div>', esc_url_raw( $slide->link ), esc_html( $slide->linktext ), wp_kses_post( '<i class="fas fa-angle-right"></i>' ) ) : '';
							?>
