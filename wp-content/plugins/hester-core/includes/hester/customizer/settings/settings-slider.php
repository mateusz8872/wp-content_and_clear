...
function hester_customizer_slider_options( array $options ) {
		...
		'control'           => array(
			...
			'fields'        => array(
				...
				'btn_1_class'         => array(
					...
					'description' => esc_html__( 'Add predefined classes btn-primary, btn-secondary, btn-white. Add `btn-outline` class to outline the button', 'hester-core' ),
					'type'        => 'text',
				),
				'btn_2_text'          => array(
	...
	$options['setting']['hester_slider_shape'] = array(
		...
		'control'           => array(
			...
			'choices'     => array(
				...
				'curved' => esc_html__( 'Bottom Curved', 'hester-core' ),
			),
		),
	);
	...
	$options['setting']['hester_slider_style'] = array(
		...
		'control'           => array(
			...
			'section'  => 'hester_section_slider',
			'choices'  => array(
				''  => esc_html__( '1 style', 'hester' ),
				'2' => esc_html__( '2 style', 'hester' ),
			),
			'required' => array(
				array(
	...
	$options['setting']['hester_slider_title_font'] = array(
		...
		'control'           => array(
			...
			'label'       => esc_html__( 'Heading Title Text', 'hester-core' ),
