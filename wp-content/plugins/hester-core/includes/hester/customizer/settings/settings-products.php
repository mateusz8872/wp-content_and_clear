...
function hester_customizer_products_options( array $options ) {
	...
	if ( ! class_exists( 'WooCommerce' ) ) {
		...
		$options['setting']['hester_products_heading'] = array(
			...
			'partial'           => array(
				...
				'render_callback'     => function () {
					return '<span class="title-shape"></span>' . get_theme_mod( 'hester_products_heading' );
				},
		...
		$desc = '<ul class="info">
                    <li>' . __( 'Show products group by categories', 'hester' ) . '</li>
                    <li>' . __( 'Number of products to show', 'hester' ) . '</li>
                    <li>' . __( 'Number of columns to show', 'hester' ) . '</li>
                </ul>';
