...
final class Hester_Core_Customizer {
	...
	public function includes() {
		...
		require_once HESTER_CORE_PLUGIN_DIR . 'includes/hester/customizer/settings/index.php';
		require_once HESTER_CORE_PLUGIN_DIR . 'includes/hester/customizer/default.php';
	}
