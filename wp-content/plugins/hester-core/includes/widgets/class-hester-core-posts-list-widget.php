		...
		if ( $posts->have_posts() ) :
			...
			while ( $posts->have_posts() ) :
				...
				if ( $instance['show_category'] ) {
					...
					echo '<div class="hester-posts-list-widget-categories">' . wp_kses( $category_icon, hester_get_allowed_html_tags( 'svg' ) ) . hester_entry_meta_category( ', ', true, true ) . '</div>';
				}
				...
				if ( $instance['show_date'] ) {
					...
					$date_icon = hester()->icons->get_svg( 'clock' );
