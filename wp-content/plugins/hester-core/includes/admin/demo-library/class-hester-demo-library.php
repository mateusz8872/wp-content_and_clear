...
final class Hester_Demo_Library {
	...
	public function admin_enqueue( $hook = '' ) {
		...
		if ( 'hester_page_hester-demo-library' !== $hook ) {
			return;
		}
		...
		$localized = array(
			...
			'is_pro'             => $is_pro,
			'upgrade_to_pro_url' => 'https://peregrine-themes.com/hester/?utm_medium=dashboard&utm_source=demos&utm_campaign=upgradeToPro',
		);
	...
	public function refresh_templates() {
		...
		wp_safe_redirect( admin_url( 'admin.php?page=hester-demo-library' ) );
		die;
	}
