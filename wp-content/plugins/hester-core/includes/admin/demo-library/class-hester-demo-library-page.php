...
final class Hester_Demo_Library_Page {
	...
	public function __construct() {
		...
		add_action( 'admin_print_footer_scripts-hester_page_hester-demo-library', array( $this, 'print_templates' ) );
		add_filter( 'hester_admin_page_tabs', array( $this, 'add_admin_page_tabs' ) );
		...
		<div class="hester-container">
			...
			<div class="demo-filters">
				...
				<ul class="demo-builders">
					<li class="selected"><a href="#" data-builder="block-editor"><?php esc_html_e( 'Gutenberg', 'hester-core' ); ?></a></li>
					<li class=""><a href="#" data-builder="elementor"><?php esc_html_e( 'Elementor', 'hester-core' ); ?></a></li>
				</ul>
			</div>
	...
	public function update_navigation_items( $items ) {
		...
		$demo = array(
			'demo-library' => array(
				...
				'icon' => '',
				'url'  => admin_url( 'admin.php?page=hester-demo-library' ),
			),
		);
